  ...
  return (
    <aside className="flex flex-col min-h-screen min-w-[290px] max-h-[1094px] shadow-lg p-4 border-r bg-gray-100">
        ...
        <div className="space-y-2">
            <NavLink to="/dashboard" className="flex items-center text-lg px-4 py-3 hover:bg-gray-200 rounded-lg">
                <img src={"/assets/dashboard1.svg"} alt="#" className="w-6 h-6 mr-2"/>Dashboard
            </NavLink>
            <NavLink to="/calendar" className="flex items-center text-lg px-4 py-3 hover:bg-gray-200 rounded-lg">
                <img src={"/assets/solarcalendar.svg"} alt="#" className="w-6 h-6 mr-2"/> Calendar
            </NavLink>
            <NavLink to="/apply-leave" className="flex items-center text-lg px-4 py-3 hover:bg-gray-200 rounded-lg">
            <img src={"/assets/Leave.svg"} alt="#" className="w-6 h-6 mr-2"/> Apply Leave
            </NavLink>
